...
(function($) {
    ...
    $.KumbiaPHP = {
        ...
        bindDatePicker: function() {
            ...
            $.getScript(this.publicPath + '/js/datepicker/datepicker.js', function(){
                bindInputs();
            });
        },
        ...
        bind : function() {
            ...
            $("a, input").on('click', '.js-confirm',this.cConfirm);

            // Enlace ajax
            $("a").on('click', '.js-remote',this.cRemote);

            // Enlace ajax con confirmacion
            $("a").on('click','.js-remote-confirm', this.cRemoteConfirm);

            // Efecto show
            $("a").on('click', '.js-show',this.cFx('show'));

            // Efecto hide
            $("a").on('click','.js-hide', this.cFx('hide'));

            // Efecto toggle
            $("a").on('click','.js-toggle', this.cFx('toggle'));

            // Efecto fadeIn
            $("a").on('click','.js-fade-in', this.cFx('fadeIn'));

            // Efecto fadeOut
            $("a").on('click', '.js-fade-out',this.cFx('fadeOut'));

            // Formulario ajax
            $("form").on('submit','.js-remote', this.cFRemote);

            // Lista desplegable que actualiza con ajax
            $("select").on('change', '.js-remote',this.cUpdaterSelect);
