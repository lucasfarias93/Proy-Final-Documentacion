            ...
            .each(function () {
                ...
                setData(
                    'selector',
                    {
                        ...
                        w: ($options.selector.maxWidth != null ? ($options.selector.w > $options.selector
.maxWidth ? $options.selector.maxWidth
                            : $options.selector.w)
                            : $options.selector.w),
                        h: ($options.selector.maxHeight != null ? ($options.selector.h > $options.selector
                    ...
                    if ($options.image.startZoom != 0) {
                        ...
                        if (getData('image').posY != 0
                            ...
                            if (getData('image').h > $options.height)
                                ...
                                getData('image').posY = (($options.height / 2) - (getData('image').h
 / 2));
                            if (getData('image').w > $options.width)
                                ...
                                getData('image').posX = (($options.width / 2) - (getData('image').w 
/ 2));
                        }
                    } else {
                ...
                function createZoomSlider() {
                    ...
                    $slider
                        .slider({
                            ...
                            step: (($options.zoomSteps > $options.image.maxZoom || $options.zoomSteps
 < 0) ? 1
                                : $options.zoomSteps),
                            slide: function (event, ui) {
                                var value = ($options.expose.slidersOrientation == 'vertical' ? ($options
.image.maxZoom - ui.value)
                                    : ui.value);
