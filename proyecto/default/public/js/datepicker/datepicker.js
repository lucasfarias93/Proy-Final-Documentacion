...
var datePickerController = (function datePickerController() {
	...
	(function() {
		...
		if(typeof(fdLocale) != "object" && jQuery != undefined) {	
			...
			for(var i = 0; i < languageInfo.length; i++) {								 
				...
				script.src  = jQuery.KumbiaPHP.publicPath + "/js/datepicker/lang/" + languageInfo[i] + ".js"; 
	...
	var localeDefaults = {
		fullMonths:["Enero","February","March","April","May","June","July","August","September","October","November","December"],
