...
class Form
{
    ...
    public static function open($action = NULL, $method = 'post', $attrs = NULL)
    {
        ...
        if ($action) {
            $action = PUBLIC_PATH . ltrim($action,'/');
        } else {
    ...
    public static function label($text, $field, $attrs = NULL)
    {
        ...
        return "<label for=\"$id\" $attrs>$text</label>";
    }
    ...
    public static function numero($field, $attrs = NULL, $value = NULL)
    {
        if (is_array($attrs)) {
            $attrs = Tag::getAttrs($attrs);
        }
        ...
        return "<input id=\"$id\" name=\"$name\" type=\"integer\" value=\"$value\" $attrs/>";
    }
    ...
    public static function date($field, $class = NULL, $attrs = NULL, $value = NULL)
    {
        ...
        return "<input id=\"$id\" name=\"$name\" class=\"date-mask $class\" type=\"text\" value=\"$value\" $attrs/>";
    }
