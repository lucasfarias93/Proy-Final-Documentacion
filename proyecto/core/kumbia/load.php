...
class Load
{
     ...
     * @throw KumbiaException
     */
    public static function negocio($experto)
    {
        $file = APP_PATH . "negocio/$experto.php";
        if (is_file($file)) {
            return require_once $file;
        } else {
            throw new KumbiaException("No existe el experto $experto");
        }
    }
        /**
     * Carga un reporte especifico
     *
     * @param string $lib libreria a cargar
     * @throw KumbiaException
     */
    ...
    {
        $file = APP_PATH . "reportes/$reporte.php";
        if (is_file($file)) {
            return require_once $file;
        } else {
            throw new KumbiaException("No existe el el reporet $reporte");
        }
    }
